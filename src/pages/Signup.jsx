...
const Signup = () => {
    ...
    return (
        <>
            <div className="w-[100%] md:px-20 px-4 py-10 lg:flex  items-center justify-center gap-16 bg-slate-100   ">
                <div className=' border  w-[40%] hidden lg:block animate-spin'> <img src="public/images/Singupimg.png" className='w-full' alt="" /> </div>
                <form autoComplete='off' className=' lg:w-[40%] md:w-[70%]  w-[100%]  bg-white py-16 lg:px-20 px-10  rounded-md' onSubmit={handleSubmit(signup)}>
                    <h3 className='text-sky-500 text-center font-bold text-xl'> SignUp </h3>
                    <div className='w-full my-5 '>
                        <label className='' htmlFor="fullname">FullName:</label>
                        <input type="text" {...register('fullname', { required: "fullname is required" })} className='w-full px-2 md:px-6 py-1 border-0 border-b outline-none ' />
                    </div>
                    ...
                    <div className='w-full my-3 '>
                        ...
                        <input type="email"  {...register('email', { required: "email is required" })} className='w-full px-2 md:px-6 py-1 border-0 border-b outline-none  ' />
                    </div>
                    ...
                    <div className='w-full my-3 '>
                        ...
                        <input type="password" {...register('password', { required: "password is required" })} className='w-full px-2 md:px-6 py-1 border-0 border-b outline-none  ' />
                    </div>
                    ...
                    <div className='w-full my-3'>
                        ...
                        })} className='w-full px-2 md:px-6 py-1 border-0 border-b outline-none  ' />
                    </div>
                    ...
                    <div className='w-full my-3 gap-3'>
                        ...
                        <input autoComplete='off' type="file" name="avater"
                            onChange={handleFileChange}  {...register('avater', { required: "file is required" })} className='w-full px-2 md:px-6 py-1 border-0 border-b outline-none  ' />
                    </div>
                    ...
                    <div className='w-[100%]   flex items-center mb-7 flex-col'>
                        ...
                        <input type="submit" value="SignUp" className='my-5 hover:bg-white duration-1000 hover:text-sky-500 border-2 font-semibold border-sky-500 px-6 py-1  outline-none bg-sky-500 rounded text-white' />
                    </div>
                </form>
            </div>
